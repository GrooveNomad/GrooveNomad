                    ...
                    <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-32 lg:pt-48">
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            ...
                            <TextEffect
                                ...
                                Chaque festival est une porte d’entrée vers une nouvelle culture. GrooveNomad t’embarque pour une aventure musicale et humaine, pensée rien que pour toi.
                            </TextEffect>
